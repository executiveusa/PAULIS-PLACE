...
but do not stop the import.`,
  ...
  printify2-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  printify2-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | printify2-pp-cli import <resource> --input -`,
