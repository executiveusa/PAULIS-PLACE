...
type rootFlags struct {
	...
	// invocation. Mirrors the PRINTIFY2_NO_LEARN env var.
	noLearn bool
...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "printify2-pp-cli",
		Short: "Manage printify2 resources via the printify2 API",
		Long: `Manage printify2 resources via the printify2 API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'printify2-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("printify2-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'printify2-pp-cli profile list')")
