...
large datasets as it has no memory pressure.`,
  ...
  printify2-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  printify2-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  printify2-pp-cli export <resource> --format jsonl | jq '.id'`,
