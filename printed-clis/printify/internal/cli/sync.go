...
import (
	...
	"printify2-pp-cli/internal/learn/lookups"
...
Resource scoping:
  ...
  printify2-pp-cli sync

  # Sync specific resources only
  printify2-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  printify2-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  printify2-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  printify2-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  printify2-pp-cli sync --latest-only`,
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"orders-json":                  "/v1/shops/{shop_id}/orders.json",
		"products-json":                "/v1/shops/{shop_id}/products.json",
		"shops-json":                   "/v1/shops.json",
		"uploads-json":                 "/v1/uploads.json",
		"webhooks-json":                "/v1/shops/{shop_id}/webhooks.json",
	}
...
var reconcileTypedTables = map[string]string{
	...
	"uploads-json":    "uploads_json",
	"webhooks":        "webhooks",
	"webhooks_json":   "webhooks_json",
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "catalog\x00/v1/catalog/blueprints/{blueprint_id}/print_providers/{print_provider_id}/variants.json":
		return []string{"variants"}
	case "catalog\x00/v1/catalog/blueprints/{blueprint_id}.json":
		return []string{"images"}
	case "catalog\x00/v1/catalog/print_providers/{print_provider_id}.json":
		return []string{"blueprints"}
	case "catalog\x00/v2/catalog/blueprints/{blueprint_id}/print_providers/{print_provider_id}/shipping.json":
		return []string{"data"}
	case "catalog\x00/v1/catalog/blueprints/{blueprint_id}/print_providers/shipping.json":
		return []string{"profiles"}
	case "catalog\x00/v1/catalog/blueprints/{blueprint_id}/print_providers/shipping/standard.json":
		return []string{"data"}
	}
	return nil
}
