...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  printify2-pp-cli which "stale tickets"
  printify2-pp-cli which "bottleneck"
  printify2-pp-cli which --limit 1 "send message"
  printify2-pp-cli which                                # list the full capability index`,
