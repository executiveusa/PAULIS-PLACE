...
import (
	...
	"printify2-pp-cli/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"printify2-pp-cli auth login",
		"printify2-pp-cli doctor",
		"printify2-pp-cli help items",
		"printify2-pp-cli sync",
		"printify2-pp-cli profile list",
		"printify2-pp-cli feedback list",
		"printify2-pp-cli which",
		"printify2-pp-cli agent-context",
		"printify2-pp-cli completion bash",
		"printify2-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"printify2-pp-cli recall",
		"printify2-pp-cli learnings",
		"printify2-pp-cli teach-pattern",
		"printify2-pp-cli teach-lookup",
		"printify2-pp-cli items list",
	}
